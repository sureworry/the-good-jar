...
function Frame() {
  return (
    <div className=\"-translate-x-1/2 -translate-y-1/2 absolute bg-[#f4f0e9] h-[106px] left-1/2 overflow-clip top-1/2 w-[320px]\">
      <Frame1 />
      <p className=\"-translate-x-1/2 [word-break:break-word] absolute font-['Louize:Regular',sans-serif] leading-[normal] left-[calc(50%+0.5px)] not-italic text-[#493a28] text-[20px] text-center top-[calc(50%-13px)] whitespace-nowrap\">|</p>
    </div>
  );
}

export default function LogTypingState() {
  return (
    <div className=\"bg-white relative size-full\" data-name=\"log typing state\">
