...
function Frame() {
  return (
    <div className=\"-translate-x-1/2 absolute bg-[#f4f0e9] h-[60px] left-1/2 overflow-clip top-[747px] w-[320px]\">
      <Frame1 />
      <p className=\"[word-break:break-word] absolute font-['Louize:Regular',sans-serif] leading-[normal] left-[calc(50%-36px)] not-italic text-[#493a28] text-[20px] top-[calc(50%-13px)] whitespace-nowrap\">log a win</p>
    </div>
  );
}
...
export default function Jar() {
  return (
    <div className=\"bg-white relative size-full\" data-name=\"jar\">
